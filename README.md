...
[![Deploy on Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https%3A%2F%2Fgithub.com%2Frailwayapp%2Fexamples%2Ftree%2Fmaster%2Fexamples%2Fflask&envs=API_HASH%2CAPI_ID%2CBANNED_CHAT_IDS%2CBANNED_USERS%2CBROADCAST_AS_COPY%2CDATABASE_URL%2CDB_CHANNEL%2CMO_TECH_YT%2CMT_BOT_OWNER%2CMT_BOT_TOKEN%2CMT_BOT_USERNAME%2CMT_LOG_CHANNEL%2CMT_UPDATES_CHANNEL&optionalEnvs=BANNED_CHAT_IDS%2CBANNED_USERS%2CBROADCAST_AS_COPY%2CMO_TECH_YT%2CMT_UPDATES_CHANNEL&API_HASHDesc=Get+it+from+my.telegram.org&API_IDDesc=Get+it+from+my.telegram.org&BANNED_CHAT_IDSDesc=Banned+unwanted+channel+IDs&BANNED_USERSDesc=Banned+unwanted+members&BROADCAST_AS_COPYDesc=Broadcast+with+Forward+Tag+or+as+Copy%28Without+Forward+Tag%29.+Value+should+be+True%2FFalse+%21%21&DATABASE_URLDesc=MongoDB+Database+URI+for+Saving+UserID+for+Broadcast.&DB_CHANNELDesc=DB_CHANNEL+Required+The+Channel+ID+which+will+be+used+as+Database.+Example%3A+-100123456789&MO_TECH_YTDesc=If+True+all+messages+will+be+forwarder+As+Copy.+If+False+all+messages+will+be+forwarder+with+Forward+Tag.+Value+should+be+True%2FFalse+%21%21&MT_BOT_OWNERDesc=Bot+Owner+UserID&MT_BOT_TOKENDesc=Get+this+from+%40BotFather+&MT_BOT_USERNAMEDesc=Your+Bot+Username+which+you+sent+to+%40BotFather+%28Without+%5B%40%5D%29&MT_LOG_CHANNELDesc=Logs+Channel+ID+for+some+Tracking+XD.+Example%3A+-100123456789&MT_UPDATES_CHANNELDesc=ID+of+a+Channel+which+you+want+to+do+Force+Sub+to+use+the+bot.+Example%3A+-100123456789&referralCode=Professor)


<details><summary>Deploy To Heroku</summary>
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/Ajay-2004/FileStoreBot-2.0">
